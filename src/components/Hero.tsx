...
const Hero = () => {
  return (
    <div className="flex items-center flex-col-reverse sm:flex-row justify-around gap-1 sm:gap-24 lg:gap-50 h-[90vh]">
        <div className="w-auto sm:w-2/3 lg:w-[40%]">
        ...
        <div className="w-2/3 sm:w-[40%] md:w-1/3 xl:w-1/4 flex items-center justify-center">
